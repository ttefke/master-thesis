...
pub type R = crate::R<DmaC3controlSpec>;
#[doc = "Register `DMA_C3Control` writer"]
pub type W = crate::W<DmaC3controlSpec>;
...
impl W {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn transfer_size(&mut self) -> TransferSizeW<'_, DmaC3controlSpec> {
        TransferSizeW::new(self, 0)
    }
    #[doc = "Bits 12:14"]
    #[inline(always)]
    pub fn sbsize(&mut self) -> SbsizeW<'_, DmaC3controlSpec> {
        SbsizeW::new(self, 12)
    }
    #[doc = "Bits 15:17"]
    #[inline(always)]
    pub fn dbsize(&mut self) -> DbsizeW<'_, DmaC3controlSpec> {
        DbsizeW::new(self, 15)
    }
    #[doc = "Bits 18:20"]
    #[inline(always)]
    pub fn swidth(&mut self) -> SwidthW<'_, DmaC3controlSpec> {
        SwidthW::new(self, 18)
    }
    #[doc = "Bits 21:23"]
    #[inline(always)]
    pub fn dwidth(&mut self) -> DwidthW<'_, DmaC3controlSpec> {
        DwidthW::new(self, 21)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn si(&mut self) -> SiW<'_, DmaC3controlSpec> {
        SiW::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn di(&mut self) -> DiW<'_, DmaC3controlSpec> {
        DiW::new(self, 27)
    }
    #[doc = "Bits 28:30"]
    #[inline(always)]
    pub fn prot(&mut self) -> ProtW<'_, DmaC3controlSpec> {
        ProtW::new(self, 28)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn i(&mut self) -> IW<'_, DmaC3controlSpec> {
        IW::new(self, 31)
    }
}
#[doc = "DMA_C3Control.\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_c3control::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_c3control::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaC3controlSpec;
impl crate::RegisterSpec for DmaC3controlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_c3control::R`](R) reader structure"]
impl crate::Readable for DmaC3controlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_c3control::W`](W) writer structure"]
impl crate::Writable for DmaC3controlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_C3Control to value 0"]
impl crate::Resettable for DmaC3controlSpec {}
