...
pub type R = crate::R<DmaC0configSpec>;
#[doc = "Register `DMA_C0Config` writer"]
pub type W = crate::W<DmaC0configSpec>;
#[doc = "Field `E` reader - "]
...
pub type LlicounterW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn e(&self) -> ER {
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn e(&mut self) -> EW<'_, DmaC0configSpec> {
        EW::new(self, 0)
    }
    #[doc = "Bits 1:5"]
    #[inline(always)]
    pub fn src_peripheral(&mut self) -> SrcPeripheralW<'_, DmaC0configSpec> {
        SrcPeripheralW::new(self, 1)
    }
    #[doc = "Bits 6:10"]
    #[inline(always)]
    pub fn dst_peripheral(&mut self) -> DstPeripheralW<'_, DmaC0configSpec> {
        DstPeripheralW::new(self, 6)
    }
    #[doc = "Bits 11:13"]
    #[inline(always)]
    pub fn flow_cntrl(&mut self) -> FlowCntrlW<'_, DmaC0configSpec> {
        FlowCntrlW::new(self, 11)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<'_, DmaC0configSpec> {
        IeW::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn itc(&mut self) -> ItcW<'_, DmaC0configSpec> {
        ItcW::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn l(&mut self) -> LW<'_, DmaC0configSpec> {
        LW::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn a(&mut self) -> AW<'_, DmaC0configSpec> {
        AW::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn h(&mut self) -> HW<'_, DmaC0configSpec> {
        HW::new(self, 18)
    }
    #[doc = "Bits 20:29"]
    #[inline(always)]
    pub fn llicounter(&mut self) -> LlicounterW<'_, DmaC0configSpec> {
        LlicounterW::new(self, 20)
    }
}
#[doc = "DMA_C0Config.\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_c0config::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_c0config::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaC0configSpec;
impl crate::RegisterSpec for DmaC0configSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_c0config::R`](R) reader structure"]
impl crate::Readable for DmaC0configSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_c0config::W`](W) writer structure"]
impl crate::Writable for DmaC0configSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_C0Config to value 0"]
impl crate::Resettable for DmaC0configSpec {}
