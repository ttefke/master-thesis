...
pub type R = crate::R<DmaC0controlSpec>;
#[doc = "Register `DMA_C0Control` writer"]
pub type W = crate::W<DmaC0controlSpec>;
...
impl W {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn transfer_size(&mut self) -> TransferSizeW<'_, DmaC0controlSpec> {
        TransferSizeW::new(self, 0)
    }
    #[doc = "Bits 12:14"]
    #[inline(always)]
    pub fn sbsize(&mut self) -> SbsizeW<'_, DmaC0controlSpec> {
        SbsizeW::new(self, 12)
    }
    #[doc = "Bits 15:17"]
    #[inline(always)]
    pub fn dbsize(&mut self) -> DbsizeW<'_, DmaC0controlSpec> {
        DbsizeW::new(self, 15)
    }
    #[doc = "Bits 18:20"]
    #[inline(always)]
    pub fn swidth(&mut self) -> SwidthW<'_, DmaC0controlSpec> {
        SwidthW::new(self, 18)
    }
    #[doc = "Bits 21:23"]
    #[inline(always)]
    pub fn dwidth(&mut self) -> DwidthW<'_, DmaC0controlSpec> {
        DwidthW::new(self, 21)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn slarger_d(&mut self) -> SlargerDW<'_, DmaC0controlSpec> {
        SlargerDW::new(self, 24)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    pub fn si(&mut self) -> SiW<'_, DmaC0controlSpec> {
        SiW::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    pub fn di(&mut self) -> DiW<'_, DmaC0controlSpec> {
        DiW::new(self, 27)
    }
    #[doc = "Bits 28:30"]
    #[inline(always)]
    pub fn prot(&mut self) -> ProtW<'_, DmaC0controlSpec> {
        ProtW::new(self, 28)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn i(&mut self) -> IW<'_, DmaC0controlSpec> {
        IW::new(self, 31)
    }
}
#[doc = "DMA_C0Control.\n\nYou can [`read`](crate::Reg::read) this register and get [`dma_c0control::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dma_c0control::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmaC0controlSpec;
impl crate::RegisterSpec for DmaC0controlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_c0control::R`](R) reader structure"]
impl crate::Readable for DmaC0controlSpec {}
#[doc = "`write(|w| ..)` method takes [`dma_c0control::W`](W) writer structure"]
impl crate::Writable for DmaC0controlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DMA_C0Control to value 0"]
impl crate::Resettable for DmaC0controlSpec {}
