...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn se_trng_0_dout_3(&mut self) -> SeTrng0Dout3W<'_, SeTrng0Dout3Spec> {
        SeTrng0Dout3W::new(self, 0)
    }
}
#[doc = "se_trng_0_dout_3.\n\nYou can [`read`](crate::Reg::read) this register and get [`se_trng_0_dout_3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`se_trng_0_dout_3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate::Writable for SeTrng0Dout3Spec {
