...
#[doc = "TICR2.\n\nYou can [`read`](crate::Reg::read) this register and get [`ticr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ticr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ticr2Spec;
impl crate::RegisterSpec for Ticr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ticr2::R`](R) reader structure"]
impl crate::Readable for Ticr2Spec {}
